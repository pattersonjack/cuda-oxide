...
rustup component add rust-src rustc-dev rust-analyzer --toolchain nightly-2026-06-16
```
...
- `rust-src component missing` -- Run `rustup component add rust-src --toolchain nightly-2026-06-16`.
:::
